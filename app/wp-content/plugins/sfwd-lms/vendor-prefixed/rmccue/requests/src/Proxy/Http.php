...
namespace StellarWP\Learndash\WpOrg\Requests\Proxy;

use StellarWP\Learndash\WpOrg\Requests\Exception\ArgumentCount;
use StellarWP\Learndash\WpOrg\Requests\Exception\InvalidArgument;
use StellarWP\Learndash\WpOrg\Requests\Hooks;
use StellarWP\Learndash\WpOrg\Requests\Proxy;
...
final class Http implements Proxy {
	 ...
	 *
	 * @throws \StellarWP\Learndash\WpOrg\Requests\Exception\InvalidArgument When the passed argument is not an array, a string or null.
	 * @throws \StellarWP\Learndash\WpOrg\Requests\Exception\ArgumentCount On incorrect number of arguments (`proxyhttpbadargs`)
	 */
	 ...
	 *
	 * @since 1.6
	 * @see \StellarWP\Learndash\WpOrg\Requests\Proxy\Http::curl_before_send()
	 * @see \StellarWP\Learndash\WpOrg\Requests\Proxy\Http::fsockopen_remote_socket()
	 * @see \StellarWP\Learndash\WpOrg\Requests\Proxy\Http::fsockopen_remote_host_path()
	 * @see \StellarWP\Learndash\WpOrg\Requests\Proxy\Http::fsockopen_header()
