...
class Jar implements ArrayAccess, IteratorAggregate {
	 ...
	 *
	 * @param string|\StellarWP\Learndash\WpOrg\Requests\Cookie $cookie Cookie header value, possibly pre-parsed (object).
	 ...
	 *
	 * @param \StellarWP\Learndash\WpOrg\Requests\Response $response Response as received.
	 */
