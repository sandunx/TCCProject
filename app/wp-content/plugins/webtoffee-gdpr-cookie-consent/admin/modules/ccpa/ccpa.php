...
class Cookie_Law_Info_CCPA
{
    ...
    public function wt_cli_ccpa_optout_callback() {
        ...
        if( $ccpa_as_link === false ) {
            ...
            $ccpa_data = '<span class="wt-cli-form-group wt-cli-custom-checkbox wt-cli-ccpa-checkbox"><input type="checkbox" id="wt-cli-ccpa-opt-out" class="wt-cli-ccpa-opt-out wt-cli-ccpa-opt-out-checkbox" tabindex="0"><label for="wt-cli-ccpa-opt-out" style="color:'.$ccpa_colour.';" >'.$ccpa_text.'</label></span>';
        
        } else {
            $ccpa_data = '<a style="color:'.$ccpa_colour.';" role="button" class="wt-cli-ccpa-opt-out" tabindex="0">'.$ccpa_text.'</a>';
        }
        return $ccpa_data;
    }
