		...
		<div class="cli_sub_tab_content" data-id="cookie-bar" style="display:block;">
			<div class="wt-cli-section wt-cli-section-general-settings">
				<table class="form-table">
					...
					<tr valign="top wt-cli-section-inner wt-cli-section-inner-gdpr" class="wt_cli_enable_consent_mode">
						<th scope="row"><label for="consent_mode_field"><?php _e("Support Google additional consent", 'webtoffee-gdpr-cookie-consent'); ?><span class="wt-cli-tootip" data-wt-cli-tooltip="<?php _e("Google's Additional Consent (AC) allows the collection of consents for Google's Ad Technology Providers (ATPs) that are not yet registered on the IAB Europe Global Vendor List (GVL). AC Mode is intended only for use alongside IAB TCF.", 'webtoffee-gdpr-cookie-consent'); ?>"><span class="wt-cli-tootip-icon"></span></span></label></th>
						<td>
							<input type="hidden" name="consent_mode_field" value="false" id="consent_mode_field_no">
							<input name="consent_mode_field" type="checkbox" value="true" id="consent_mode_field_yes" class="wt-cli-input-toggle-checkbox" data-cli-toggle-target="wt-cli-consent-mode" <?php checked($the_options['consent_mode'], true); ?>>
							<label><?php _e("Enable", 'webtoffee-gdpr-cookie-consent');?></label>
						</td>
					</tr>
				</table>
			</div>
