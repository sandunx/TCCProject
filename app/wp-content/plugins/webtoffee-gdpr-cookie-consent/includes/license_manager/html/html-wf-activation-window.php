	...
	<div class="aw-contents-container">
		...
		<div id="aw-deactivation" class="content-row <?php echo $show_deactivation; ?>">
			...
			<div class="aw-deactivation-info">
				License: <span id="info-licence-key"><?php echo esc_html( $this->mask_licence_key($licence_key) ); ?></span> &nbsp;|&nbsp;
				Mail: <span id="info-licence-mail"><?php echo esc_html( $mail ); ?></span> &nbsp;|&nbsp;
				Status: <span id="info-status"><?php echo esc_html( $status ); ?></span>
