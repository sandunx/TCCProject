...
= 2.5.7 03-05-2024 =
* [Fix] : Fixed vendor count related issue in IAB banner
* [Enhancement] : License key masking.
* [Enhancement] : Updated translation files.
* [Compatibility] : Tested OK with WordPress 6.4.3

= 2.5.6 01-30-2024 =
* [Add] : Support for Google additional consent mode.
* [Enhancement] : Updated translation files.

= 2.5.5 12-13-2023 =
* [Fix] : Could not establish connection to cookie scanner.

= 2.5.4 12-05-2023 =
* [Fix] : Removed unwanted style from plugin code.
* [Fix] : Update is not working even after the force check.
* [Compatibility] : Scanner is now compatible with PHP 8.2.
* [Compatibility] : Tested OK with WordPress 6.4.1

= 2.5.3 09-29-2023 =
* [Fix] : IAB scripts loaded when IAB is disabled issue fixed.
* [Fix] : Fixed website speed/performance issue after installing the plugin.
* [Enhancement] : Updated translation files.

= 2.5.2 09-12-2023 =
* [Fix] : All cookies are accepted when clicking the "Save and Accept" button issue fixed.
* [Enhancement] : Updated translation files.
...
= 2.5.0 08-17-2023 =
* [Fix] : Minor bug fixes
* [Add] : IAB TCF compliance
* [Add] : Introduced filter "wt_cli_consent_log_date_filter" for exporting consent report based on certain date range
* [Compatibility] : Tested OK with WordPress 6.3

= 2.4.0 =
* Fix: Errors are thrown while checking updates
* Enhancement: Disabled server-side cookie checking for improved caching

= 2.3.9 =
* Fix: Option to enable/disable plugin"Auto-update" is not working
* Fix: Update is not working sometime even after the force check

= 2.3.8 =
* Fix: Categories of "Sells Personal Information" are enabled even after user optout from selling data.
* Fix: License check URL get's changed automatically when in WPML domain mode.
* Fix: Cache support for the short code [user_consent_state]
* Fix: Script blocker is not working properly when Polylang plugin is active
* Improvement: New filter `wt_cli_cookie_scanner_url_per_scan` for changing number of urls per scan request.
