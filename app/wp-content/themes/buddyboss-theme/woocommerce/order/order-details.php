		...
		<table class="woocommerce-table woocommerce-table--order-details shop_table shop_table_responsive order_details order_details_items">
			...
			<thead>
				<tr>
					...
					<th class="woocommerce-table__product-name product-name"><?php esc_html_e( 'Product', 'buddyboss-theme' ); ?></th>
					<th class="woocommerce-table__product-name product-qty"><?php esc_html_e( 'Qty', 'buddyboss-theme' ); ?></th>
					<th class="woocommerce-table__product-table product-total"><?php esc_html_e( 'Total', 'buddyboss-theme' ); ?></th>
				</tr>
			</thead>
